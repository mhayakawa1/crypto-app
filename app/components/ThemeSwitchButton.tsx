...
export function ThemeSwitchButton() {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="icon"
      className="flex justify-center items-center w-[48px] max-md:w-[36px] lg:2xl:w-[72px] h-auto aspect-square rounded-[6px] lg:2xl:rounded-[9px] border-none dark:border dark:border-[--dark-gunmetal] bg-[--lavender] dark:bg-[--mirage]"
    >
      <Image alt="" src={darkActive ? Sun : Moon} className="max-md:h-[18px] lg:2xl:h-[36px] w-auto"/>
    </Button>
  );
}
