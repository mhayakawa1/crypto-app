  ...
  return (
    <Panel className="flex justify-center items-center px-[20px] max-sm:px-[2vw] lg:2xl:px-[30px] py-[16px] lg:2xl:py-[24px] gap-[16px] lg:2xl:gap-[24px] font-medium text-base h-auto">
      ...
      <Popover>
        ...
        <PopoverContent className='border-none w-fit h-fit py-1 px-2 flex justify-center items-center bg-[--perano] dark:bg-[--dark-slate-blue] text-xs text-white'><span>Link Copied!</span></PopoverContent>
      </Popover>
    </Panel>
  );
};
