...
const ProgressContainer = (props: {
  ...
  return (
    <div>
      <div className="w-full flex justify-between items-center h-[16px] lg:2xl:h-[24px]">
        <div
          className={`lg:2xl:text-2xl flex justify-between items-center gap-[4px] lg:2xl:gap-[6px] text-[${classes.progressColor}]`}
        >
          <span
            className={`w-[6px] lg:2xl:w-[9px] h-[6px] lg:2xl:h-[9px] rounded-full ${classes.progressColorBG}`}
          >
          </span>
            {values[0] ? formatNumber(values[0]) : "--"}
        </div>
        <div className="lg:2xl:text-2xl flex content-between items-center gap-[4px] lg:2xl:gap-[6px]">
          <span
            className={`w-[6px] lg:2xl:w-[9px] h-[6px] lg:2xl:h-[9px] rounded-full ${classes.barColor}`}
          ></span>
